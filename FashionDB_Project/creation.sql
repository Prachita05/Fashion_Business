-- Fashion Business Database Schema
...
CREATE TABLE Clothing_Item_Fabrics (
...
-- Insert into Sold_In (Item-Sale relationships)
...
(1, 1), -- Sabyasachi creates Festive Splendor
(2, 2), -- Manish creates Heritage Weaves
(3, 3), -- Anita creates Modern Sarees
(4, 4), -- Rohit creates Royal Sherwanis
(5, 5); -- Tarun creates Bridal Dreams